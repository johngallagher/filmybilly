...
namespace :magic do
    ...
    task :convert, :erb_path, :output_path do |t, args|
        ...
        ErbToBackboneConverter.new(erb_buffer, intermediate_path, output_buffer, :helper_tags => helper_tags, :locals => { }).convert
